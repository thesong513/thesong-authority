...
(
    power_id   int auto_increment comment '权限id'
        primary key,
    power_name varchar(100) not null comment '权限类型',
...
INSERT INTO shiro.t_role_power (id, role_id, power_id) VALUES (2, 1, 2);
INSERT INTO shiro.t_role_power (id, role_id, power_id) VALUES (3, 1, 3);
...
INSERT INTO shiro.t_role_power (id, role_id, power_id) VALUES (11, 1, 11);
